	...
	render() {
		...
		return (
            ...
            <div key={index} style={{ padding: "5px", display: "inline-block"}}>
							<div key={index} style={{ borderStyle: "solid", borderWidth: "1px", borderRadius: "3px", textSize:"1em", borderColor: BLUE_BORDER, color: "white", display: "inline-block", padding: "5px", width: "200px"}} className="checkboxblue">	
